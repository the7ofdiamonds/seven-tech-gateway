<link rel="stylesheet" href=<?php echo SEVEN_TECH_GATEWAY_URL . "Admin/includes/css/AccountManagementUpdate.css"; ?>>
<script src=<?php echo SEVEN_TECH_GATEWAY_URL . "Admin/includes/js/AccountManagementUpdate.js"; ?> defer></script>

<div class="account-management-update" id="account_management_update">
