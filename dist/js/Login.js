 ...
 */var re=new $n("@firebase/auth");function et(a){if(re.logLevel<=Zr.WARN){for(var r=arguments.length,e=new Array(r>1?r-1:0),t=1;t<r;t++)e[t-1]=arguments[t];re.warn.apply(re,["Auth (".concat(ce,"): ").concat(a)].concat(e))}}function we(a){if(re.logLevel<=Zr.ERROR){for(var r=arguments.length,e=new Array(r>1?r-1:0),t=1;t<r;t++)e[t-1]=arguments[t];re.error.apply(re,["Auth (".concat(ce,"): ").concat(a)].concat(e))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(){return He=p(c().mark(function a(r,e){return c().wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return n.abrupt("return",ie(r,"POST","/v1/accounts:lookup",e));case 1:case"end":return n.stop()}},a)})),He.apply(this,arguments)}function ue(a){if(a)try{var r=new Date(Number(a));if(!isNaN(r.getTime()))return r.toUTCString()}catch{}}function ht(a){return ze.apply(this,arguments)}function ze(){return ze=p(c().mark(function a(r){var e,t,n,i,s,u,o=arguments;return c().wrap(function(h){for(;;)switch(h.prev=h.next){case 0:return e=o.length>1&&o[1]!==void 0?o[1]:!1,t=te(r),h.next=4,t.getIdToken(e);case 4:return n=h.sent,i=yr(n),y(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error"),s=Kn(i.firebase)==="object"?i.firebase:void 0,u=s==null?void 0:s.sign_in_provider,h.abrupt("return",{claims:i,token:n,authTime:ue(Ne(i.auth_time)),issuedAtTime:ue(Ne(i.iat)),expirationTime:ue(Ne(i.exp)),signInProvider:u||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null});case 10:case"end":return h.stop()}},a)})),ze.apply(this,arguments)}function Ne(a){return Number(a)*1e3}function yr(a){var r=a.split("."),e=$(r,3),t=e[0],n=e[1],i=e[2];if(t===void 0||n===void 0||i===void 0)return we("JWT malformed, contained fewer than 3 sections"),null;try{var s=Jn(n);return s?JSON.parse(s):(we("Failed to decode base64 JWT payload"),null)}catch(u){return we("Caught error parsing JWT payload as JSON",u==null?void 0:u.toString()),null}}function dt(a){var r=yr(a);return y(r,"internal-error"),y(typeof r.exp<"u","internal-error"),y(typeof r.iat<"u","internal-error"),Number(r.exp)-Number(r.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dr(a){var r=a.toLowerCase();if(r.includes("opera/")||r.includes("opr/")||r.includes("opios/"))return"Opera";if(cn(r))return"IEMobile";if(r.includes("msie")||r.includes("trident/"))return"IE";if(r.includes("edge/"))return"Edge";if(on(r))return"Firefox";if(r.includes("silk/"))return"Silk";if(dn(r))return"Blackberry";if(fn(r))return"Webos";if(Ir(r))return"Safari";if((r.includes("chrome/")||ln(r))&&!r.includes("edge/"))return"Chrome";if(hn(r))return"Android";var e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,t=a.match(e);return(t==null?void 0:t.length)===2?t[1]:"Other"}function on(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/firefox\//i.test(a)}function Ir(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M(),r=a.toLowerCase();return r.includes("safari/")&&!r.includes("chrome/")&&!r.includes("crios/")&&!r.includes("android")}function ln(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/crios\//i.test(a)}function cn(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/iemobile/i.test(a)}function hn(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/android/i.test(a)}function dn(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/blackberry/i.test(a)}function fn(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/webos/i.test(a)}function Ee(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return/iphone|ipad|ipod/i.test(a)||/macintosh/i.test(a)&&/mobile/i.test(a)}function yt(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M(),r;return Ee(a)&&!!(!((r=window.navigator)===null||r===void 0)&&r.standalone)}function It(){return Gn()&&document.documentMode===10}function pn(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:M();return Ee(a)||hn(a)||fn(a)||dn(a)||/windows phone/i.test(a)||cn(a)}function bt(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var _i=new de(3e4,6e4);function zr(){var a=V().___jsl;if(a!=null&&a.H)for(var r=0,e=Object.keys(a.H);r<e.length;r++){var t=e[r];if(a.H[t].r=a.H[t].r||[],a.H[t].L=a.H[t].L||[],a.H[t].r=Y(a.H[t].L),a.CP)for(var n=0;n<a.CP.length;n++)a.CP[n]=null}}function Si(a){return new Promise(function(r,e){var t,n,i;function s(){zr(),gapi.load("gapi.iframes",{callback:function(){r(gapi.iframes.getContext())},ontimeout:function(){zr(),e(j(a,"network-request-failed"))},timeout:_i.get()})}if(!((n=(t=V().gapi)===null||t===void 0?void 0:t.iframes)===null||n===void 0)&&n.Iframe)r(gapi.iframes.getContext());else if(!((i=V().gapi)===null||i===void 0)&&i.load)s();else{var u=Ct("iframefcb");return V()[u]=function(){gapi.load?s():e(j(a,"network-request-failed"))},At("https://apis.google.com/js/api.js?onload=".concat(u)).catch(function(o){return e(o)})}}).catch(function(r){throw be=null,r})}var be=null;function Ei(a){return be=be||Si(a),be}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
