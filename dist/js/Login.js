import{E as gr,L as Hn,m as k,n as xr,o as b,p as H,q as z,t as Nr,C as Lr,v as Mr,w as zn,x as en,y as qn,z as Gn,A as T,B as Bn,D as Kn,S as le,a as p,b as c,F as ie,G as Jn,_ as $,H as ce,I as Q,J as L,K as Xn,M as Yn,N as rn,O as nn,P as mr,Q as ue,R as ee,T as re,U as Qn,V as Zn,W as xn,u as we,r as D,j as y,X as et,Y as Re,Z as Ae,$ as Ce,a0 as Oe,a1 as Ne,a2 as Le}from"./index.js";import{u as rt,S as nt}from"./StatusBarComponent.js";import{N as tt}from"./NavigationLoginComponent.js";function kr(a,r){var e={};for(var t in a)Object.prototype.hasOwnProperty.call(a,t)&&r.indexOf(t)<0&&(e[t]=a[t]);if(a!=null&&typeof Object.getOwnPropertySymbols=="function")for(var n=0,t=Object.getOwnPropertySymbols(a);n<t.length;n++)r.indexOf(t[n])<0&&Object.prototype.propertyIsEnumerable.call(a,t[n])&&(e[t[n]]=a[t[n]]);return e}var x;function tn(){return k({},"dependent-sdk-initialized-before-auth","Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK.")}var it=tn,$e=new gr("auth","Firebase",tn());/**
 * @license
