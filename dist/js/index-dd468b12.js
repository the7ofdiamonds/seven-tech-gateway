import{E as tr,L as Tn,e as k,m as $r,n as b,o as U,p as M,q as K,s as vr,C as gr,t as mr,v as _n,w as Vr,x as En,y as Rn,z as I,A as Pn,B as An,S as ee,f,g as c,D as Sn,_ as re,F as ne,G as j,H as S,I as Wr,J as Cn,K as On,M as Hr,N as ir,O as Y,P as q,Q as G,R as Nn,T as Ln,U as Un}from"./index.js";function ar(a,r){var e={};for(var t in a)Object.prototype.hasOwnProperty.call(a,t)&&r.indexOf(t)<0&&(e[t]=a[t]);if(a!=null&&typeof Object.getOwnPropertySymbols=="function")for(var n=0,t=Object.getOwnPropertySymbols(a);n<t.length;n++)r.indexOf(t[n])<0&&Object.prototype.propertyIsEnumerable.call(a,t[n])&&(e[t[n]]=a[t[n]]);return e}var z;function jr(){return k({},"dependent-sdk-initialized-before-auth","Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK.")}var Mn=jr,ye=new tr("auth","Firebase",jr());/**
 * @license
 ...
 */var B=new Tn("@firebase/auth");function Dn(a){if(B.logLevel<=Hr.WARN){for(var r=arguments.length,e=new Array(r>1?r-1:0),t=1;t<r;t++)e[t-1]=arguments[t];B.warn.apply(B,["Auth (".concat(ee,"): ").concat(a)].concat(e))}}function ue(a){if(B.logLevel<=Hr.ERROR){for(var r=arguments.length,e=new Array(r>1?r-1:0),t=1;t<r;t++)e[t-1]=arguments[t];B.error.apply(B,["Auth (".concat(ee,"): ").concat(a)].concat(e))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ot=function(){function a(r){I(this,a),this.auth=r,this.queue=[]}return b(a,[{key:"pushCallback",value:function(e,t){var n=this,i=function(o){return new Promise(function(l,h){try{var d=e(o);l(d)}catch(m){h(m)}})};i.onAbort=t,this.queue.push(i);var s=this.queue.length-1;return function(){n.queue[s]=function(){return Promise.resolve()}}}},{key:"runMiddleware",value:function(){var r=f(c().mark(function t(n){var i,s,u,o,l,h,d;return c().wrap(function(p){for(;;)switch(p.prev=p.next){case 0:if(this.auth.currentUser!==n){p.next=2;break}return p.abrupt("return");case 2:i=[],p.prev=3,s=Y(this.queue),p.prev=5,s.s();case 7:if((u=s.n()).done){p.next=14;break}return o=u.value,p.next=11,o(n);case 11:o.onAbort&&i.push(o.onAbort);case 12:p.next=7;break;case 14:p.next=19;break;case 16:p.prev=16,p.t0=p.catch(5),s.e(p.t0);case 19:return p.prev=19,s.f(),p.finish(19);case 22:p.next=30;break;case 24:p.prev=24,p.t1=p.catch(3),i.reverse(),l=Y(i);try{for(l.s();!(h=l.n()).done;){d=h.value;try{d()}catch{}}}catch(g){l.e(g)}finally{l.f()}throw this.auth._errorFactory.create("login-blocked",{originalMessage:p.t1===null||p.t1===void 0?void 0:p.t1.message});case 30:case"end":return p.stop()}},t,this,[[3,24],[5,16,19,22]])}));function e(t){return r.apply(this,arguments)}return e}()}]),a}();/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(a,r){return Ve.apply(this,arguments)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ji=5*60,Ki=$r("authIdTokenMaxAge")||ji,Fr=null,zi=function(r){return function(){var e=f(c().mark(function t(n){var i,s,u;return c().wrap(function(l){for(;;)switch(l.prev=l.next){case 0:if(l.t0=n,!l.t0){l.next=5;break}return l.next=4,n.getIdTokenResult();case 4:l.t0=l.sent;case 5:if(i=l.t0,s=i&&(new Date().getTime()-Date.parse(i.issuedAtTime))/1e3,!(s&&s>Ki)){l.next=9;break}return l.abrupt("return");case 9:if(u=i==null?void 0:i.token,Fr!==u){l.next=12;break}return l.abrupt("return");case 12:return Fr=u,l.next=15,fetch(r,{method:u?"POST":"DELETE",headers:u?{Authorization:"Bearer ".concat(u)}:{}});case 15:case"end":return l.stop()}},t)}));return function(t){return e.apply(this,arguments)}}()};function Xi(){var a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:_n(),r=Vr(a,"auth");if(r.isInitialized())return r.getImmediate();var e=wt(a,{popupRedirectResolver:$i,persistence:[Xt,$t,dn]}),t=$r("authTokenSyncURL");if(t){var n=zi(t);Ut(e,n,function(){return n(e.currentUser)}),Lt(e,function(s){return n(s)})}var i=En("auth");return i&&It(e,"http://".concat(i)),e}Hi("Browser");export{un as G,Gi as O,Bi as a,Xi as g,Ji as o,Yi as s};
